...
class GetMessagesDetailsResponse(object):

    """Implementation of the 'Get Messages  Details response' model.

    Gets details of messages with optional filters. Returns paginated
    messages, next page or previous page
    ...
    def __init__(self,
                 ...
                 error_code=None,
                 data=None):
        """Constructor for the GetMessagesDetailsResponse class"""
